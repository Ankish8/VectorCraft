...
export const Navbar = ({ children, className }: NavbarProps) => {
  ...
  return (
    <motion.div
      ref={ref}
      className={cn("fixed inset-x-0 z-[60] w-full", className)}
      style={{ top: '64px' }}
    >
...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-[70] mx-auto hidden w-full mt-2 max-w-7xl flex-row items-center justify-between self-start rounded-md bg-transparent px-4 py-2 lg:flex dark:bg-transparent",
  ...
  return (
    ...
    >
      <span className="font-medium text-black dark:text-white">
        VECTOR<span className="text-blue-600">CRAFT</span>
      </span>
    </a>
  );
};
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    ...
    secondary: "bg-transparent shadow-none dark:text-white border border-gray-300",
